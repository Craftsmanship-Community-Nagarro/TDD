...
class BoundaryTest {
  ...
  @Test
  void shouldNotCrossTheBoundaryMovingBackwardHeadingWestOnTheEdge() {
    final Robot robot = new Robot();
    robot.dropOnSurface(9, 9);
    ...
    assertThat(robot.getLongitude()).isEqualTo(9);
    assertThat(robot.getLatitude()).isEqualTo(9);
  }

  @Test
  void shouldNotCrossTheBoundaryMovingBackwardHeadingSouthOnTheEdge() {
    final Robot robot = new Robot();
    robot.dropOnSurface(9, 9);
